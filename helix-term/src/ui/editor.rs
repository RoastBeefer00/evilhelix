...
impl EditorView {
    ...
    pub fn doc_selection_highlights(
        ...
        let cursor_scope = match mode {
            ...
            Mode::SelectLine => theme.find_highlight_exact("ui.cursor.select"),
            Mode::Normal => theme.find_highlight_exact("ui.cursor.normal"),
            Mode::Netrw => theme.find_highlight_exact("ui.cursor.normal"),
        }
        .unwrap_or(base_cursor_scope);
        ...
        let primary_cursor_scope = match mode {
            ...
            Mode::Netrw => theme.find_highlight_exact("ui.cursor.primary.normal"),
        }
